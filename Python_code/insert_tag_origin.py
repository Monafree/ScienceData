...
def insert_row(rowkey,batch,row):
	batch.put(rowkey.__str__(),{"data:entry":row[0],"data:runNo":row[1],"data:eventId":row[2],
		"data:totalCharged":row[3],"data:totalNeutral":row[4],"data:totalTrks":row[5]})
